...
files = {
    'src/components/ForHer.js': '''import React from 'react'
        ...
        <div className='u20MainParent fof '>
            ...
            <div className='u20Featyres relative'>
                ...
                <div className='u20FeaturesHold flex flex-row relative'>
                    ...
                    <BsCurrencyRupee className='w-16 h-20' />
...
export default ForHer;''',
    'src/components/ForHim.js': '''import React from 'react'
import u20bg from "../assets/u20bg.png";
import "../styles/Under20.css";
import {
    Breadcrumb,
...
export default ForHim;''',
    'src/components/Under10.js': '''import React from 'react'
import u20bg from "../assets/u20bg.png";
import "../styles/Under20.css";
import {
    Breadcrumb,
...
export default Under10;''',
    'src/components/Under20.js': '''import React from 'react'
import u20bg from "../assets/u20bg.png";
import "../styles/Under20.css";
import {
    Breadcrumb,
