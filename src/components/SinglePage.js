  ...
  return (
    <div className='singlePageMainParent relative top-36'>
      ...
      <figure className='singlePageMainPicHold relative'>
        {imgChnage === true ? <SafeImage src={activeImg} alt={name} className=" w-48 cursor-pointer rounded-2xl object-cover singlePageMainPic" /> : <SafeImage src={image} alt={name} className=" w-48 cursor-pointer rounded-2xl object-cover singlePageMainPic" />}
      </figure>
      ...
      <div className='sideImageHold flex flex-col relative gap-12'>
        <SafeImage src={hoverImg} alt={`${name} alternate`} className=" w-64 cursor-pointer  object-cover" onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
        <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/products/NO_Lists_for_Site-SIG_21bc4fd3-c2b5-4e21-8244-1f0f61cce160_540x.png?v=1599504641' alt={`${name} ingredients`} className='w-64 cursor-pointer rounded-lg object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>

      <div className='bottomImgHold flex flex-row relative gap-8'>
        <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/products/anysiaalice_image_720x.jpg?v=1599504641' alt={`${name} lifestyle`} className=' w-80 si cursor-pointer object-cover' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
        <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/products/anysiaalice_quote-1_720x.jpg?v=1599504641' alt={`${name} review`} className=' w-80 si cursor-pointer object-cover' id='mobileDontSHow' onMouseEnter={imgSrcTarget} onMouseLeave={defaultImageSrc} />
      </div>
      ...
      <div className='footerFeatures2 flex flex-row absolute'>
        ...
        <BiRupee className='w-16 h-20 sv' />
