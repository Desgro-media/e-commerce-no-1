...
import SafeImage, { SafeHoverImage } from './SafeImage';
        ...
        <div>
                            ...
                            return (
                                <Link to={`/${item.id}`} key={item.id}>
                                    ...
                                    <div key={item.id} className="bodyTypeIndivitual">
                                        <SafeHoverImage src={item.primaryImage} hoverSrc={item.hoverImg} alt={item.name} className="rounded-xl  bodyTypeImage" />
            ...
            {show2 && <div className=' z-50 hairContent flex flex-col' onMouseLeave={dontShowHandler}>
                ...
                <div className='hairImageHold flex flex-row gap-10'>
                    <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/articles/Natural_Balance_Shampoo_02_540x.jpg?v=1550710011' alt='Natural haircare' className=' rounded-xl w-52' />
                    <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/articles/ee7ea9c87918e493665a3a84bdf6c00a_large_1b25100f-7d60-451b-9d01-e74d104141d5_540x.jpg?v=1550710009' alt='Sustainable lifestyle' className=' rounded-xl w-52' />
                </div>
                                ...
                                return (
                                    <Link to={`/${item.id}`} key={item.id}>
                                        ...
                                        <div key={item.id} className="TravelIndivitual">
                                            <SafeHoverImage src={item.primaryImage} hoverSrc={item.hoverImg} alt={item.name} className=" rounded-xl w-40" />
