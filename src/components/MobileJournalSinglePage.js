        ...
        <div>
            <div className='jsMainParent mt-28' id='mjspJournal'>
                ...
                <div className='jsLeft'>
                    <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/files/Sukin_Journal_Heading_2-01_2500x2500_6e692e60-90cb-4cd0-9006-a6f1d09fe1c4_360x.png?v=1613561992' alt='Sukin journal' className=' w-72' />
                ...
                <div className='jsRight flex flex-row gap-24'>
                    ...
                    <Link to={`/journal/april`}>
                        <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/articles/400x400_blog_540x.jpg?v=1652511342' alt='Protective haircare styles and tips' className='jsImg rounded-xl' />
                    </Link>

                    <SafeImage src='https://cdn.shopify.com/s/files/1/0081/7374/8305/articles/BBQ_1200x440_7b63676b-f505-4b21-9192-e1b43a53be32_540x.jpg?v=1625596357' alt='Guide to a backyard BBQ' className='jsImg rounded-xl' />
